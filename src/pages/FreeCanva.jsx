...
export default function FreeCanva() {
  ...
  useEffect(() => {
    ...
    // 4. Inject Confetti Script for the "Woo Hoo" step
              ...
              <div className="flex items-start gap-4 relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <button 
                    ...
                    className="w-full bg-gray-900 hover:bg-black text-white font-bold text-[12px] py-3 rounded-xl shadow-md active:scale-95 transition-all flex items-center justify-center gap-2"
                  >
