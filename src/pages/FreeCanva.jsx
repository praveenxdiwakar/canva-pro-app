...
export default function FreeCanva() {
  ...
  // Trigger Canva Pro Colored Confetti when hitting step 6 (after completing 5 steps)
  useEffect(() => {
    if (currentStep > 5 && window.confetti) {
      ...
      (function frame() {
        // Shoot confetti from the left edge (Canva Pro Colors)
        window.confetti({
          particleCount: 5,
          angle: 60,
          spread: 55,
        ...
        // Shoot confetti from the right edge (Canva Pro Colors)
        window.confetti({
          particleCount: 5,
          angle: 120,
          spread: 55,
        ...
        <AnimatePresence>
          {currentStep > 5 && (
            <motion.div 
              ...
              className="bg-white rounded-3xl p-5 border border-purple-100 shadow-sm relative overflow-hidden"
            >
