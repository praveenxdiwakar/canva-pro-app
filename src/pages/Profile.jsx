...
export default function Profile() {
  ...
  // Fetch user profile data and points balance
  ...
  // Fetch activity statistics (streak, invited friends, lifetime points, etc.)
  ...
  // Fetch app configurations for support links
  ...
  // Fallback profile details if Telegram web app context is loading or in dev mode
  ...
  const telegramId = telegramUser?.telegramId || userData?.telegramId || "1044031607";
  ...
  return (
    <div className="bg-[#f5f5f5] min-h-[calc(100dvh-5rem)] pb-24 relative">
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {/* Invite Friends & Earn Referral Section */}
